    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
          <div className="bg-white p-8 rounded-3xl shadow-xl max-w-md w-full text-center border border-gray-100 animate-in fade-in slide-in-from-bottom-8">
            ...
            <div className="bg-slate-100 p-3 rounded-lg text-xs font-mono text-left mb-6 overflow-auto max-h-32 text-slate-600 border border-slate-200">
